      ...
      <section className="relative mx-auto max-w-7xl px-4 pb-14 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_.92fr]">
          <div>
            ...
            <h1 className="max-w-5xl text-balance bg-gradient-to-br from-white via-slate-100 to-cyan-100 bg-clip-text text-[40px] font-semibold leading-[1.12] tracking-[-0.025em] text-transparent sm:text-5xl lg:text-6xl">
